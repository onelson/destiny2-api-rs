...
impl InlineResponse20023 {
  ...
  pub fn with_response(mut self, response: ::models::GroupsV2GroupApplicationResponse) -> InlineResponse20023 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20023 {
    self.error_code = Some(error_code);
    self
  }
