...
pub struct InlineResponse20010 {
  ...
  response: Option<::models::MessagesResponsesSaveMessageResult>,
...
impl InlineResponse20010 {
  ...
  pub fn set_response(&mut self, response: ::models::MessagesResponsesSaveMessageResult) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: ::models::MessagesResponsesSaveMessageResult) -> InlineResponse20010 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&::models::MessagesResponsesSaveMessageResult> {
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20010 {
    self.error_code = Some(error_code);
    self
  }
