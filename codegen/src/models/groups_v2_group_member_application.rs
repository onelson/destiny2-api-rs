...
pub struct GroupsV2GroupMemberApplication {
  ...
  resolve_state: Option<::models::GroupsV2GroupApplicationResolveState>,
...
impl GroupsV2GroupMemberApplication {
  ...
  pub fn set_resolve_state(&mut self, resolve_state: ::models::GroupsV2GroupApplicationResolveState) {
    self.resolve_state = Some(resolve_state);
  }

  pub fn with_resolve_state(mut self, resolve_state: ::models::GroupsV2GroupApplicationResolveState) -> GroupsV2GroupMemberApplication {
    self.resolve_state = Some(resolve_state);
    self
  }

  pub fn resolve_state(&self) -> Option<&::models::GroupsV2GroupApplicationResolveState> {
  ...
  pub fn with_destiny_user_info(mut self, destiny_user_info: ::models::UserUserInfoCard) -> GroupsV2GroupMemberApplication {
    self.destiny_user_info = Some(destiny_user_info);
    self
  }
