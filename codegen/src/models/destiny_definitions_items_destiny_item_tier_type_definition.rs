...
pub struct DestinyDefinitionsItemsDestinyItemTierTypeDefinition {
  ...
  infusion_process: Option<Object>,
...
impl DestinyDefinitionsItemsDestinyItemTierTypeDefinition {
  ...
  pub fn set_infusion_process(&mut self, infusion_process: Object) {
    self.infusion_process = Some(infusion_process);
  }

  pub fn with_infusion_process(mut self, infusion_process: Object) -> DestinyDefinitionsItemsDestinyItemTierTypeDefinition {
    self.infusion_process = Some(infusion_process);
    self
  }

  pub fn infusion_process(&self) -> Option<&Object> {
