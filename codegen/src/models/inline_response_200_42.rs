...
impl InlineResponse20042 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyDefinitionsDestinyEntitySearchResult) -> InlineResponse20042 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20042 {
    self.error_code = Some(error_code);
    self
  }
