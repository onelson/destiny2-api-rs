...
impl InlineResponse20040 {
  ...
  pub fn with_response(mut self, response: ::std::collections::HashMap<String, ::std::collections::HashMap<String, ::models::DestinyHistoricalStatsDestinyLeaderboard>>) -> InlineResponse20040 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20040 {
    self.error_code = Some(error_code);
    self
  }
