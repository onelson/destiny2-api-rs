...
pub struct DestinyEntitiesCharactersDestinyCharacterActivitiesComponent {
  ...
  current_activity_mode_types: Option<Vec<::models::DestinyHistoricalStatsDefinitionsDestinyActivityModeType>>,
...
impl DestinyEntitiesCharactersDestinyCharacterActivitiesComponent {
  ...
  pub fn set_current_activity_mode_types(&mut self, current_activity_mode_types: Vec<::models::DestinyHistoricalStatsDefinitionsDestinyActivityModeType>) {
    self.current_activity_mode_types = Some(current_activity_mode_types);
  }

  pub fn with_current_activity_mode_types(mut self, current_activity_mode_types: Vec<::models::DestinyHistoricalStatsDefinitionsDestinyActivityModeType>) -> DestinyEntitiesCharactersDestinyCharacterActivitiesComponent {
    self.current_activity_mode_types = Some(current_activity_mode_types);
    self
  }

  pub fn current_activity_mode_types(&self) -> Option<&Vec<::models::DestinyHistoricalStatsDefinitionsDestinyActivityModeType>> {
