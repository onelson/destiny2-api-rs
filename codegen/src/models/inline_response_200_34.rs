...
impl InlineResponse20034 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyResponsesDestinyItemResponse) -> InlineResponse20034 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20034 {
    self.error_code = Some(error_code);
    self
  }
