...
impl InlineResponse20031 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyResponsesDestinyProfileResponse) -> InlineResponse20031 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20031 {
    self.error_code = Some(error_code);
    self
  }
