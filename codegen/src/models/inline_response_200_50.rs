...
impl InlineResponse20050 {
  ...
  pub fn with_response(mut self, response: ::models::SearchResultOfCommunityLiveStatus) -> InlineResponse20050 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20050 {
    self.error_code = Some(error_code);
    self
  }
