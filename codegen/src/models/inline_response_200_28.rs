...
impl InlineResponse20028 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyConfigDestinyManifest) -> InlineResponse20028 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20028 {
    self.error_code = Some(error_code);
    self
  }
