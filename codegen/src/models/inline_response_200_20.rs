...
impl InlineResponse20020 {
  ...
  pub fn with_response(mut self, response: ::models::SearchResultOfGroupMember) -> InlineResponse20020 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20020 {
    self.error_code = Some(error_code);
    self
  }
