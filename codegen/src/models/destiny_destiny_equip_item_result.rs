...
impl DestinyDestinyEquipItemResult {
  ...
  pub fn set_equip_status(&mut self, equip_status: Object) {
    self.equip_status = Some(equip_status);
  }

  pub fn with_equip_status(mut self, equip_status: Object) -> DestinyDestinyEquipItemResult {
    self.equip_status = Some(equip_status);
    self
  }

  pub fn equip_status(&self) -> Option<&Object> {
