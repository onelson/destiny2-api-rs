...
pub struct GroupsV2GroupResponse {
  ...
  alliance_status: Option<::models::GroupsV2GroupAllianceStatus>,
...
impl GroupsV2GroupResponse {
  ...
  pub fn set_alliance_status(&mut self, alliance_status: ::models::GroupsV2GroupAllianceStatus) {
    self.alliance_status = Some(alliance_status);
  }

  pub fn with_alliance_status(mut self, alliance_status: ::models::GroupsV2GroupAllianceStatus) -> GroupsV2GroupResponse {
    self.alliance_status = Some(alliance_status);
    self
  }

  pub fn alliance_status(&self) -> Option<&::models::GroupsV2GroupAllianceStatus> {
