...
impl DestinyEntitiesCharactersDestinyCharacterRenderComponent {
  ...
  pub fn set_customization(&mut self, customization: Object) {
    self.customization = Some(customization);
  }

  pub fn with_customization(mut self, customization: Object) -> DestinyEntitiesCharactersDestinyCharacterRenderComponent {
    self.customization = Some(customization);
    self
  }

  pub fn customization(&self) -> Option<&Object> {
  ...
  pub fn set_peer_view(&mut self, peer_view: Object) {
    self.peer_view = Some(peer_view);
  }

  pub fn with_peer_view(mut self, peer_view: Object) -> DestinyEntitiesCharactersDestinyCharacterRenderComponent {
    self.peer_view = Some(peer_view);
    self
  }

  pub fn peer_view(&self) -> Option<&Object> {
