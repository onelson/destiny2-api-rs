...
pub struct ContentContentItemPublicContract {
  ...
  properties: Option<::std::collections::HashMap<String, Object>>,
...
impl ContentContentItemPublicContract {
  ...
  pub fn set_properties(&mut self, properties: ::std::collections::HashMap<String, Object>) {
    self.properties = Some(properties);
  }

  pub fn with_properties(mut self, properties: ::std::collections::HashMap<String, Object>) -> ContentContentItemPublicContract {
    self.properties = Some(properties);
    self
  }

  pub fn properties(&self) -> Option<&::std::collections::HashMap<String, Object>> {
