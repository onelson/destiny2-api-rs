...
impl InlineResponse20015 {
  ...
  pub fn with_response(mut self, response: i32) -> InlineResponse20015 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20015 {
    self.error_code = Some(error_code);
    self
  }
