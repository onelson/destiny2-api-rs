...
impl InlineResponse20045 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyHistoricalStatsDestinyActivityHistoryResults) -> InlineResponse20045 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20045 {
    self.error_code = Some(error_code);
    self
  }
