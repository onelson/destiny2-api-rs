...
pub struct DestinyDefinitionsDestinyTalentNodeDefinition {
  ...
  random_activation_requirement: Option<Object>,
...
impl DestinyDefinitionsDestinyTalentNodeDefinition {
  ...
  pub fn set_random_activation_requirement(&mut self, random_activation_requirement: Object) {
    self.random_activation_requirement = Some(random_activation_requirement);
  }

  pub fn with_random_activation_requirement(mut self, random_activation_requirement: Object) -> DestinyDefinitionsDestinyTalentNodeDefinition {
    self.random_activation_requirement = Some(random_activation_requirement);
    self
  }

  pub fn random_activation_requirement(&self) -> Option<&Object> {
