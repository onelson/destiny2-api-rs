...
impl InlineResponse2007 {
  ...
  pub fn with_response(mut self, response: i64) -> InlineResponse2007 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2007 {
    self.error_code = Some(error_code);
    self
  }
