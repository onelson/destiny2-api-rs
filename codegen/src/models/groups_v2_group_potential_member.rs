...
pub struct GroupsV2GroupPotentialMember {
  ...
  potential_status: Option<::models::GroupsV2GroupPotentialMemberStatus>,
...
impl GroupsV2GroupPotentialMember {
  ...
  pub fn set_potential_status(&mut self, potential_status: ::models::GroupsV2GroupPotentialMemberStatus) {
    self.potential_status = Some(potential_status);
  }

  pub fn with_potential_status(mut self, potential_status: ::models::GroupsV2GroupPotentialMemberStatus) -> GroupsV2GroupPotentialMember {
    self.potential_status = Some(potential_status);
    self
  }

  pub fn potential_status(&self) -> Option<&::models::GroupsV2GroupPotentialMemberStatus> {
  ...
  pub fn with_destiny_user_info(mut self, destiny_user_info: ::models::UserUserInfoCard) -> GroupsV2GroupPotentialMember {
    self.destiny_user_info = Some(destiny_user_info);
    self
  }
