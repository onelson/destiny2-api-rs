...
impl InlineResponse20025 {
  ...
  pub fn with_response(mut self, response: Vec<::models::EntitiesEntityActionResult>) -> InlineResponse20025 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20025 {
    self.error_code = Some(error_code);
    self
  }
