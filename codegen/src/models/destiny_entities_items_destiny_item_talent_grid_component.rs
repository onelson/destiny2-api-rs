...
pub struct DestinyEntitiesItemsDestinyItemTalentGridComponent {
  ...
  grid_progression: Option<Object>
}
...
impl DestinyEntitiesItemsDestinyItemTalentGridComponent {
  ...
  pub fn set_grid_progression(&mut self, grid_progression: Object) {
    self.grid_progression = Some(grid_progression);
  }

  pub fn with_grid_progression(mut self, grid_progression: Object) -> DestinyEntitiesItemsDestinyItemTalentGridComponent {
    self.grid_progression = Some(grid_progression);
    self
  }

  pub fn grid_progression(&self) -> Option<&Object> {
