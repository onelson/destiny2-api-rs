...
pub struct TrendingTrendingEntryCommunityStream {
  ...
  partnership_type: Option<::models::PartnershipsPartnershipType>
}
...
impl TrendingTrendingEntryCommunityStream {
  ...
  pub fn set_partnership_type(&mut self, partnership_type: ::models::PartnershipsPartnershipType) {
    self.partnership_type = Some(partnership_type);
  }

  pub fn with_partnership_type(mut self, partnership_type: ::models::PartnershipsPartnershipType) -> TrendingTrendingEntryCommunityStream {
    self.partnership_type = Some(partnership_type);
    self
  }

  pub fn partnership_type(&self) -> Option<&::models::PartnershipsPartnershipType> {
