...
impl InlineResponse20036 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyResponsesDestinyVendorResponse) -> InlineResponse20036 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20036 {
    self.error_code = Some(error_code);
    self
  }
