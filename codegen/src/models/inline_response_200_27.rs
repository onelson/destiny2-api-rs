...
impl InlineResponse20027 {
  ...
  pub fn with_response(mut self, response: ::models::GroupsV2GroupPotentialMembershipSearchResponse) -> InlineResponse20027 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20027 {
    self.error_code = Some(error_code);
    self
  }
