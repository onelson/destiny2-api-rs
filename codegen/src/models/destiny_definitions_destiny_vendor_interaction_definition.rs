...
pub struct DestinyDefinitionsDestinyVendorInteractionDefinition {
  ...
  header_display_properties: Option<Object>,
...
impl DestinyDefinitionsDestinyVendorInteractionDefinition {
  ...
  pub fn set_header_display_properties(&mut self, header_display_properties: Object) {
    self.header_display_properties = Some(header_display_properties);
  }

  pub fn with_header_display_properties(mut self, header_display_properties: Object) -> DestinyDefinitionsDestinyVendorInteractionDefinition {
    self.header_display_properties = Some(header_display_properties);
    self
  }

  pub fn header_display_properties(&self) -> Option<&Object> {
