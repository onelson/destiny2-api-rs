...
pub struct DestinyEntitiesItemsDestinyItemInstanceComponent {
  ...
  cannot_equip_reason: Option<Object>
}
...
impl DestinyEntitiesItemsDestinyItemInstanceComponent {
  ...
  pub fn with_damage_type(mut self, damage_type: Object) -> DestinyEntitiesItemsDestinyItemInstanceComponent {
    self.damage_type = Some(damage_type);
    self
  }
  ...
  pub fn set_primary_stat(&mut self, primary_stat: Object) {
    self.primary_stat = Some(primary_stat);
  }

  pub fn with_primary_stat(mut self, primary_stat: Object) -> DestinyEntitiesItemsDestinyItemInstanceComponent {
    self.primary_stat = Some(primary_stat);
    self
  }

  pub fn primary_stat(&self) -> Option<&Object> {
  ...
  pub fn set_cannot_equip_reason(&mut self, cannot_equip_reason: Object) {
    self.cannot_equip_reason = Some(cannot_equip_reason);
  }

  pub fn with_cannot_equip_reason(mut self, cannot_equip_reason: Object) -> DestinyEntitiesItemsDestinyItemInstanceComponent {
    self.cannot_equip_reason = Some(cannot_equip_reason);
    self
  }

  pub fn cannot_equip_reason(&self) -> Option<&Object> {
