...
impl InlineResponse20052 {
  ...
  pub fn with_response(mut self, response: ::models::TrendingTrendingCategories) -> InlineResponse20052 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20052 {
    self.error_code = Some(error_code);
    self
  }
