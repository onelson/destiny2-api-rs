...
impl InlineResponse20026 {
  ...
  pub fn with_response(mut self, response: ::models::GroupsV2GroupMembershipSearchResponse) -> InlineResponse20026 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20026 {
    self.error_code = Some(error_code);
    self
  }
