...
impl InlineResponse20032 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyResponsesDestinyCharacterResponse) -> InlineResponse20032 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20032 {
    self.error_code = Some(error_code);
    self
  }
