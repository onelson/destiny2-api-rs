...
impl InlineResponse20012 {
  ...
  pub fn with_response(mut self, response: ::std::collections::HashMap<String, String>) -> InlineResponse20012 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20012 {
    self.error_code = Some(error_code);
    self
  }
