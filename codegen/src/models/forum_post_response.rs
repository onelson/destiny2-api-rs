...
pub struct ForumPostResponse {
  ...
  url_media_type: Option<::models::ForumForumMediaType>,
  #[serde(rename = "thumbnail")]
  thumbnail: Option<String>,
  #[serde(rename = "popularity")]
  popularity: Option<::models::ForumForumPostPopularity>,
...
impl ForumPostResponse {
  ...
  pub fn set_url_media_type(&mut self, url_media_type: ::models::ForumForumMediaType) {
    self.url_media_type = Some(url_media_type);
  }

  pub fn with_url_media_type(mut self, url_media_type: ::models::ForumForumMediaType) -> ForumPostResponse {
    self.url_media_type = Some(url_media_type);
    self
  }

  pub fn url_media_type(&self) -> Option<&::models::ForumForumMediaType> {
  ...
  pub fn set_popularity(&mut self, popularity: ::models::ForumForumPostPopularity) {
    self.popularity = Some(popularity);
  }

  pub fn with_popularity(mut self, popularity: ::models::ForumForumPostPopularity) -> ForumPostResponse {
    self.popularity = Some(popularity);
    self
  }

  pub fn popularity(&self) -> Option<&::models::ForumForumPostPopularity> {
