...
pub struct InlineResponse2009 {
  ...
  response: Option<::models::ForumForumRecruitmentDetail>,
...
impl InlineResponse2009 {
  ...
  pub fn set_response(&mut self, response: ::models::ForumForumRecruitmentDetail) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: ::models::ForumForumRecruitmentDetail) -> InlineResponse2009 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&::models::ForumForumRecruitmentDetail> {
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2009 {
    self.error_code = Some(error_code);
    self
  }
