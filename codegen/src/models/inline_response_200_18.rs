...
impl InlineResponse20018 {
  ...
  pub fn with_response(mut self, response: Vec<::models::GroupsV2GroupOptionalConversation>) -> InlineResponse20018 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20018 {
    self.error_code = Some(error_code);
    self
  }
