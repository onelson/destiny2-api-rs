...
impl InlineResponse20013 {
  ...
  pub fn with_response(mut self, response: Vec<::models::ConfigGroupTheme>) -> InlineResponse20013 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20013 {
    self.error_code = Some(error_code);
    self
  }
