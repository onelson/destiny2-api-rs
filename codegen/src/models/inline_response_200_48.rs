...
impl InlineResponse20048 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyMilestonesDestinyMilestoneContent) -> InlineResponse20048 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20048 {
    self.error_code = Some(error_code);
    self
  }
