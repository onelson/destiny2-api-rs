...
impl InlineResponse20011 {
  ...
  pub fn with_response(mut self, response: Vec<::models::ForumForumRecruitmentDetail>) -> InlineResponse20011 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20011 {
    self.error_code = Some(error_code);
    self
  }
