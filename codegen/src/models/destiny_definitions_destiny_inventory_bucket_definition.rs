...
impl DestinyDefinitionsDestinyInventoryBucketDefinition {
  ...
  pub fn with_scope(mut self, scope: Object) -> DestinyDefinitionsDestinyInventoryBucketDefinition {
    self.scope = Some(scope);
    self
  }
  ...
  pub fn with_category(mut self, category: Object) -> DestinyDefinitionsDestinyInventoryBucketDefinition {
    self.category = Some(category);
    self
  }
  ...
  pub fn with_location(mut self, location: Object) -> DestinyDefinitionsDestinyInventoryBucketDefinition {
    self.location = Some(location);
    self
  }
