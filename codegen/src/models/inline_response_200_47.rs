...
impl InlineResponse20047 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyHistoricalStatsDestinyAggregateActivityResults) -> InlineResponse20047 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20047 {
    self.error_code = Some(error_code);
    self
  }
