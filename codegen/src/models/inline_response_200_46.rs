...
impl InlineResponse20046 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyHistoricalStatsDestinyHistoricalWeaponStatsData) -> InlineResponse20046 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20046 {
    self.error_code = Some(error_code);
    self
  }
