...
impl InlineResponse20017 {
  ...
  pub fn with_response(mut self, response: ::models::GroupsV2GroupResponse) -> InlineResponse20017 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20017 {
    self.error_code = Some(error_code);
    self
  }
