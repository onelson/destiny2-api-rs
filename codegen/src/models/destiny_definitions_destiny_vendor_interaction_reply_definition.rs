...
impl DestinyDefinitionsDestinyVendorInteractionReplyDefinition {
  ...
  pub fn set_item_rewards_selection(&mut self, item_rewards_selection: Object) {
    self.item_rewards_selection = Some(item_rewards_selection);
  }

  pub fn with_item_rewards_selection(mut self, item_rewards_selection: Object) -> DestinyDefinitionsDestinyVendorInteractionReplyDefinition {
    self.item_rewards_selection = Some(item_rewards_selection);
    self
  }

  pub fn item_rewards_selection(&self) -> Option<&Object> {
  ...
  pub fn set_reply_type(&mut self, reply_type: Object) {
    self.reply_type = Some(reply_type);
  }

  pub fn with_reply_type(mut self, reply_type: Object) -> DestinyDefinitionsDestinyVendorInteractionReplyDefinition {
    self.reply_type = Some(reply_type);
    self
  }

  pub fn reply_type(&self) -> Option<&Object> {
