...
impl GroupsV2GroupV2Card {
  ...
  pub fn with_group_type(mut self, group_type: ::models::GroupsV2GroupType) -> GroupsV2GroupV2Card {
    self.group_type = Some(group_type);
    self
  }
  ...
  pub fn with_membership_option(mut self, membership_option: ::models::GroupsV2MembershipOption) -> GroupsV2GroupV2Card {
    self.membership_option = Some(membership_option);
    self
  }
  ...
  pub fn with_capabilities(mut self, capabilities: ::models::GroupsV2Capabilities) -> GroupsV2GroupV2Card {
    self.capabilities = Some(capabilities);
    self
  }
