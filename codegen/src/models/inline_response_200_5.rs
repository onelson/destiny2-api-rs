...
impl InlineResponse2005 {
  ...
  pub fn with_response(mut self, response: Vec<::models::PartnershipsPublicPartnershipDetail>) -> InlineResponse2005 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2005 {
    self.error_code = Some(error_code);
    self
  }
