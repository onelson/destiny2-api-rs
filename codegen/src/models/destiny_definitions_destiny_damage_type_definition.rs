...
impl DestinyDefinitionsDestinyDamageTypeDefinition {
  ...
  pub fn with_display_properties(mut self, display_properties: Object) -> DestinyDefinitionsDestinyDamageTypeDefinition {
    self.display_properties = Some(display_properties);
    self
  }
  ...
  pub fn set_enum_value(&mut self, enum_value: Object) {
    self.enum_value = Some(enum_value);
  }

  pub fn with_enum_value(mut self, enum_value: Object) -> DestinyDefinitionsDestinyDamageTypeDefinition {
    self.enum_value = Some(enum_value);
    self
  }

  pub fn enum_value(&self) -> Option<&Object> {
