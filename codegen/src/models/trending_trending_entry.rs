...
impl TrendingTrendingEntry {
  ...
  pub fn set_entity_type(&mut self, entity_type: Object) {
    self.entity_type = Some(entity_type);
  }

  pub fn with_entity_type(mut self, entity_type: Object) -> TrendingTrendingEntry {
    self.entity_type = Some(entity_type);
    self
  }

  pub fn entity_type(&self) -> Option<&Object> {
