...
impl InlineResponse20033 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyMilestonesDestinyMilestone) -> InlineResponse20033 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20033 {
    self.error_code = Some(error_code);
    self
  }
