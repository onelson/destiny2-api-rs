...
impl InlineResponse20014 {
  ...
  pub fn with_response(mut self, response: bool) -> InlineResponse20014 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20014 {
    self.error_code = Some(error_code);
    self
  }
