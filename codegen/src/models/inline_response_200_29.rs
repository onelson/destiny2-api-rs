...
impl InlineResponse20029 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyDefinitionsDestinyDefinition) -> InlineResponse20029 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20029 {
    self.error_code = Some(error_code);
    self
  }
