...
impl InlineResponse20016 {
  ...
  pub fn with_response(mut self, response: ::models::GroupsV2GroupSearchResponse) -> InlineResponse20016 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20016 {
    self.error_code = Some(error_code);
    self
  }
