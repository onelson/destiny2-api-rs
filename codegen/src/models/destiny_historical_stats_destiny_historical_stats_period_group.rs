...
pub struct DestinyHistoricalStatsDestinyHistoricalStatsPeriodGroup {
  ...
  activity_details: Option<Object>,
...
impl DestinyHistoricalStatsDestinyHistoricalStatsPeriodGroup {
  ...
  pub fn set_activity_details(&mut self, activity_details: Object) {
    self.activity_details = Some(activity_details);
  }

  pub fn with_activity_details(mut self, activity_details: Object) -> DestinyHistoricalStatsDestinyHistoricalStatsPeriodGroup {
    self.activity_details = Some(activity_details);
    self
  }

  pub fn activity_details(&self) -> Option<&Object> {
