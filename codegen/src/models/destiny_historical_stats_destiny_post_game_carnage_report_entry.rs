...
impl DestinyHistoricalStatsDestinyPostGameCarnageReportEntry {
  ...
  pub fn with_score(mut self, score: Object) -> DestinyHistoricalStatsDestinyPostGameCarnageReportEntry {
    self.score = Some(score);
    self
  }
  ...
  pub fn with_player(mut self, player: Object) -> DestinyHistoricalStatsDestinyPostGameCarnageReportEntry {
    self.player = Some(player);
    self
  }
  ...
  pub fn set_extended(&mut self, extended: Object) {
    self.extended = Some(extended);
  }

  pub fn with_extended(mut self, extended: Object) -> DestinyHistoricalStatsDestinyPostGameCarnageReportEntry {
    self.extended = Some(extended);
    self
  }

  pub fn extended(&self) -> Option<&Object> {
