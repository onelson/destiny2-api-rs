...
impl DestinyDefinitionsDestinyEntitySearchResult {
  ...
  pub fn set_results(&mut self, results: Object) {
    self.results = Some(results);
  }

  pub fn with_results(mut self, results: Object) -> DestinyDefinitionsDestinyEntitySearchResult {
    self.results = Some(results);
    self
  }

  pub fn results(&self) -> Option<&Object> {
    self.results.as_ref()
  }
