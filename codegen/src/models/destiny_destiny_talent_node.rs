...
pub struct DestinyDestinyTalentNode {
  ...
  node_stats_block: Option<Object>
}
...
impl DestinyDestinyTalentNode {
  ...
  pub fn with_state(mut self, state: Object) -> DestinyDestinyTalentNode {
    self.state = Some(state);
    self
  }
  ...
  pub fn set_node_stats_block(&mut self, node_stats_block: Object) {
    self.node_stats_block = Some(node_stats_block);
  }

  pub fn with_node_stats_block(mut self, node_stats_block: Object) -> DestinyDestinyTalentNode {
    self.node_stats_block = Some(node_stats_block);
    self
  }

  pub fn node_stats_block(&self) -> Option<&Object> {
