...
impl InlineResponse20041 {
  ...
  pub fn with_response(mut self, response: Vec<::models::DestinyHistoricalStatsDestinyClanAggregateStat>) -> InlineResponse20041 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20041 {
    self.error_code = Some(error_code);
    self
  }
