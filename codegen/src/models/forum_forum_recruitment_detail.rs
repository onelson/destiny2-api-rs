...
pub struct ForumForumRecruitmentDetail {
  ...
  intensity: Option<::models::ForumForumRecruitmentIntensityLabel>,
  #[serde(rename = "tone")]
  tone: Option<::models::ForumForumRecruitmentToneLabel>,
...
impl ForumForumRecruitmentDetail {
  ...
  pub fn set_intensity(&mut self, intensity: ::models::ForumForumRecruitmentIntensityLabel) {
    self.intensity = Some(intensity);
  }

  pub fn with_intensity(mut self, intensity: ::models::ForumForumRecruitmentIntensityLabel) -> ForumForumRecruitmentDetail {
    self.intensity = Some(intensity);
    self
  }

  pub fn intensity(&self) -> Option<&::models::ForumForumRecruitmentIntensityLabel> {
  ...
  pub fn set_tone(&mut self, tone: ::models::ForumForumRecruitmentToneLabel) {
    self.tone = Some(tone);
  }

  pub fn with_tone(mut self, tone: ::models::ForumForumRecruitmentToneLabel) -> ForumForumRecruitmentDetail {
    self.tone = Some(tone);
    self
  }

  pub fn tone(&self) -> Option<&::models::ForumForumRecruitmentToneLabel> {
    self.tone.as_ref()
  }
