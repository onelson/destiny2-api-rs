...
impl DestinyVendorsDestinyVendorReceipt {
  ...
  pub fn set_item_received(&mut self, item_received: Object) {
    self.item_received = Some(item_received);
  }

  pub fn with_item_received(mut self, item_received: Object) -> DestinyVendorsDestinyVendorReceipt {
    self.item_received = Some(item_received);
    self
  }

  pub fn item_received(&self) -> Option<&Object> {
  ...
  pub fn with_refund_policy(mut self, refund_policy: Object) -> DestinyVendorsDestinyVendorReceipt {
    self.refund_policy = Some(refund_policy);
    self
  }
