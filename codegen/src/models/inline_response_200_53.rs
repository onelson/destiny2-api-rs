...
impl InlineResponse20053 {
  ...
  pub fn with_response(mut self, response: ::models::SearchResultOfTrendingEntry) -> InlineResponse20053 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20053 {
    self.error_code = Some(error_code);
    self
  }
