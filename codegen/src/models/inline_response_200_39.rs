...
impl InlineResponse20039 {
  ...
  pub fn with_response(mut self, response: ::std::collections::HashMap<String, ::models::DestinyHistoricalStatsDefinitionsDestinyHistoricalStatsDefinition>) -> InlineResponse20039 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20039 {
    self.error_code = Some(error_code);
    self
  }
