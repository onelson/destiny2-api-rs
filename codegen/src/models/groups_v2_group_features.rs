...
pub struct GroupsV2GroupFeatures {
  ...
  capabilities: Option<::models::GroupsV2Capabilities>,
  #[serde(rename = "membershipTypes")]
  membership_types: Option<Vec<::models::BungieMembershipType>>,
  ...
  host_guided_game_permission_override: Option<Object>,
...
impl GroupsV2GroupFeatures {
  ...
  pub fn set_capabilities(&mut self, capabilities: ::models::GroupsV2Capabilities) {
    self.capabilities = Some(capabilities);
  }

  pub fn with_capabilities(mut self, capabilities: ::models::GroupsV2Capabilities) -> GroupsV2GroupFeatures {
    self.capabilities = Some(capabilities);
    self
  }

  pub fn capabilities(&self) -> Option<&::models::GroupsV2Capabilities> {
  ...
  pub fn set_membership_types(&mut self, membership_types: Vec<::models::BungieMembershipType>) {
    self.membership_types = Some(membership_types);
  }

  pub fn with_membership_types(mut self, membership_types: Vec<::models::BungieMembershipType>) -> GroupsV2GroupFeatures {
    self.membership_types = Some(membership_types);
    self
  }

  pub fn membership_types(&self) -> Option<&Vec<::models::BungieMembershipType>> {
  ...
  pub fn set_host_guided_game_permission_override(&mut self, host_guided_game_permission_override: Object) {
    self.host_guided_game_permission_override = Some(host_guided_game_permission_override);
  }

  pub fn with_host_guided_game_permission_override(mut self, host_guided_game_permission_override: Object) -> GroupsV2GroupFeatures {
    self.host_guided_game_permission_override = Some(host_guided_game_permission_override);
    self
  }

  pub fn host_guided_game_permission_override(&self) -> Option<&Object> {
  ...
  pub fn set_join_level(&mut self, join_level: Object) {
    self.join_level = Some(join_level);
  }

  pub fn with_join_level(mut self, join_level: Object) -> GroupsV2GroupFeatures {
    self.join_level = Some(join_level);
    self
  }

  pub fn join_level(&self) -> Option<&Object> {
