...
pub struct DestinyEntitiesCharactersDestinyCharacterComponent {
  ...
  level_progression: Option<Object>,
...
impl DestinyEntitiesCharactersDestinyCharacterComponent {
  ...
  pub fn with_membership_type(mut self, membership_type: Object) -> DestinyEntitiesCharactersDestinyCharacterComponent {
    self.membership_type = Some(membership_type);
    self
  }
  ...
  pub fn set_race_type(&mut self, race_type: Object) {
    self.race_type = Some(race_type);
  }

  pub fn with_race_type(mut self, race_type: Object) -> DestinyEntitiesCharactersDestinyCharacterComponent {
    self.race_type = Some(race_type);
    self
  }

  pub fn race_type(&self) -> Option<&Object> {
  ...
  pub fn with_class_type(mut self, class_type: Object) -> DestinyEntitiesCharactersDestinyCharacterComponent {
    self.class_type = Some(class_type);
    self
  }
  ...
  pub fn with_gender_type(mut self, gender_type: Object) -> DestinyEntitiesCharactersDestinyCharacterComponent {
    self.gender_type = Some(gender_type);
    self
  }
  ...
  pub fn set_level_progression(&mut self, level_progression: Object) {
    self.level_progression = Some(level_progression);
  }

  pub fn with_level_progression(mut self, level_progression: Object) -> DestinyEntitiesCharactersDestinyCharacterComponent {
    self.level_progression = Some(level_progression);
    self
  }

  pub fn level_progression(&self) -> Option<&Object> {
