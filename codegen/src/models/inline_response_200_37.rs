...
impl InlineResponse20037 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyDestinyEquipItemResults) -> InlineResponse20037 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20037 {
    self.error_code = Some(error_code);
    self
  }
