...
impl DestinyDefinitionsMilestonesDestinyMilestoneDefinition {
  ...
  pub fn set_milestone_type(&mut self, milestone_type: Object) {
    self.milestone_type = Some(milestone_type);
  }

  pub fn with_milestone_type(mut self, milestone_type: Object) -> DestinyDefinitionsMilestonesDestinyMilestoneDefinition {
    self.milestone_type = Some(milestone_type);
    self
  }

  pub fn milestone_type(&self) -> Option<&Object> {
