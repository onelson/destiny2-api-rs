...
impl InlineResponse2006 {
  ...
  pub fn with_response(mut self, response: ::models::ForumPostSearchResponse) -> InlineResponse2006 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2006 {
    self.error_code = Some(error_code);
    self
  }
