...
pub struct GroupsV2GroupV2 {
  ...
  #[serde(rename = "primaryAlliedGroupId")]
  primary_allied_group_id: Option<i64>,
  #[serde(rename = "motto")]
  motto: Option<String>,
  ...
  default_publicity: Option<::models::GroupsV2GroupPostPublicity>,
  #[serde(rename = "theme")]
  theme: Option<String>,
  ...
  #[serde(rename = "isAllianceOwner")]
  is_alliance_owner: Option<bool>,
...
impl GroupsV2GroupV2 {
  ...
  pub fn with_group_type(mut self, group_type: ::models::GroupsV2GroupType) -> GroupsV2GroupV2 {
    self.group_type = Some(group_type);
    self
  }
  ...
  pub fn set_primary_allied_group_id(&mut self, primary_allied_group_id: i64) {
    self.primary_allied_group_id = Some(primary_allied_group_id);
  }

  pub fn with_primary_allied_group_id(mut self, primary_allied_group_id: i64) -> GroupsV2GroupV2 {
    self.primary_allied_group_id = Some(primary_allied_group_id);
    self
  }

  pub fn primary_allied_group_id(&self) -> Option<&i64> {
    self.primary_allied_group_id.as_ref()
  }

  pub fn reset_primary_allied_group_id(&mut self) {
    self.primary_allied_group_id = None;
  }
  ...
  pub fn with_chat_security(mut self, chat_security: ::models::GroupsV2ChatSecuritySetting) -> GroupsV2GroupV2 {
    self.chat_security = Some(chat_security);
    self
  }
  ...
  pub fn with_homepage(mut self, homepage: ::models::GroupsV2GroupHomepage) -> GroupsV2GroupV2 {
    self.homepage = Some(homepage);
    self
  }
  ...
  pub fn with_membership_option(mut self, membership_option: ::models::GroupsV2MembershipOption) -> GroupsV2GroupV2 {
    self.membership_option = Some(membership_option);
    self
  }
  ...
  pub fn set_default_publicity(&mut self, default_publicity: ::models::GroupsV2GroupPostPublicity) {
    self.default_publicity = Some(default_publicity);
  }

  pub fn with_default_publicity(mut self, default_publicity: ::models::GroupsV2GroupPostPublicity) -> GroupsV2GroupV2 {
    self.default_publicity = Some(default_publicity);
    self
  }

  pub fn default_publicity(&self) -> Option<&::models::GroupsV2GroupPostPublicity> {
  ...
  pub fn set_is_alliance_owner(&mut self, is_alliance_owner: bool) {
    self.is_alliance_owner = Some(is_alliance_owner);
  }

  pub fn with_is_alliance_owner(mut self, is_alliance_owner: bool) -> GroupsV2GroupV2 {
    self.is_alliance_owner = Some(is_alliance_owner);
    self
  }

  pub fn is_alliance_owner(&self) -> Option<&bool> {
    self.is_alliance_owner.as_ref()
  }

  pub fn reset_is_alliance_owner(&mut self) {
    self.is_alliance_owner = None;
  }
