...
impl InlineResponse2002 {
  ...
  pub fn with_response(mut self, response: Vec<::models::UserGeneralUser>) -> InlineResponse2002 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2002 {
    self.error_code = Some(error_code);
    self
  }
