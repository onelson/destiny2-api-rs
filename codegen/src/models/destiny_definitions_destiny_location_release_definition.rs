...
impl DestinyDefinitionsDestinyLocationReleaseDefinition {
  ...
  pub fn with_display_properties(mut self, display_properties: Object) -> DestinyDefinitionsDestinyLocationReleaseDefinition {
    self.display_properties = Some(display_properties);
    self
  }
  ...
  pub fn set_nav_point_type(&mut self, nav_point_type: Object) {
    self.nav_point_type = Some(nav_point_type);
  }

  pub fn with_nav_point_type(mut self, nav_point_type: Object) -> DestinyDefinitionsDestinyLocationReleaseDefinition {
    self.nav_point_type = Some(nav_point_type);
    self
  }

  pub fn nav_point_type(&self) -> Option<&Object> {
