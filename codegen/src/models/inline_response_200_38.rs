...
impl InlineResponse20038 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyHistoricalStatsDestinyPostGameCarnageReportData) -> InlineResponse20038 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20038 {
    self.error_code = Some(error_code);
    self
  }
