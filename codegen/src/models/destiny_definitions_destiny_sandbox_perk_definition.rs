...
impl DestinyDefinitionsDestinySandboxPerkDefinition {
  ...
  pub fn with_display_properties(mut self, display_properties: Object) -> DestinyDefinitionsDestinySandboxPerkDefinition {
    self.display_properties = Some(display_properties);
    self
  }
  ...
  pub fn with_damage_type(mut self, damage_type: Object) -> DestinyDefinitionsDestinySandboxPerkDefinition {
    self.damage_type = Some(damage_type);
    self
  }
  ...
  pub fn set_perk_groups(&mut self, perk_groups: Object) {
    self.perk_groups = Some(perk_groups);
  }

  pub fn with_perk_groups(mut self, perk_groups: Object) -> DestinyDefinitionsDestinySandboxPerkDefinition {
    self.perk_groups = Some(perk_groups);
    self
  }

  pub fn perk_groups(&self) -> Option<&Object> {
