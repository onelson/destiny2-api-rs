...
pub struct TrendingTrendingDetail {
  ...
  entity_type: Option<::models::TrendingTrendingEntryType>,
  #[serde(rename = "news")]
...
impl TrendingTrendingDetail {
  ...
  pub fn set_entity_type(&mut self, entity_type: ::models::TrendingTrendingEntryType) {
    self.entity_type = Some(entity_type);
  }

  pub fn with_entity_type(mut self, entity_type: ::models::TrendingTrendingEntryType) -> TrendingTrendingDetail {
    self.entity_type = Some(entity_type);
    self
  }

  pub fn entity_type(&self) -> Option<&::models::TrendingTrendingEntryType> {
