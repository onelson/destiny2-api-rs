...
impl InlineResponse20024 {
  ...
  pub fn with_response(mut self, response: ::models::SearchResultOfGroupMemberApplication) -> InlineResponse20024 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20024 {
    self.error_code = Some(error_code);
    self
  }
