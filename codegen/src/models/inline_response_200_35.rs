...
pub struct InlineResponse20035 {
  ...
  response: Option<Vec<::models::DestinyResponsesDestinyVendorResponse>>,
...
impl InlineResponse20035 {
  ...
  pub fn set_response(&mut self, response: Vec<::models::DestinyResponsesDestinyVendorResponse>) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: Vec<::models::DestinyResponsesDestinyVendorResponse>) -> InlineResponse20035 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&Vec<::models::DestinyResponsesDestinyVendorResponse>> {
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20035 {
    self.error_code = Some(error_code);
    self
  }
