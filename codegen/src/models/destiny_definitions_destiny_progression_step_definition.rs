...
pub struct DestinyDefinitionsDestinyProgressionStepDefinition {
  ...
  display_effect_type: Option<Object>,
...
impl DestinyDefinitionsDestinyProgressionStepDefinition {
  ...
  pub fn set_display_effect_type(&mut self, display_effect_type: Object) {
    self.display_effect_type = Some(display_effect_type);
  }

  pub fn with_display_effect_type(mut self, display_effect_type: Object) -> DestinyDefinitionsDestinyProgressionStepDefinition {
    self.display_effect_type = Some(display_effect_type);
    self
  }

  pub fn display_effect_type(&self) -> Option<&Object> {
