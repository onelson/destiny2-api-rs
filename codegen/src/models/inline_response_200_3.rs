...
impl InlineResponse2003 {
  ...
  pub fn with_response(mut self, response: Vec<::models::ConfigUserTheme>) -> InlineResponse2003 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2003 {
    self.error_code = Some(error_code);
    self
  }
