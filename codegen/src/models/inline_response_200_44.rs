...
impl InlineResponse20044 {
  ...
  pub fn with_response(mut self, response: ::models::DestinyHistoricalStatsDestinyHistoricalStatsAccountResult) -> InlineResponse20044 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20044 {
    self.error_code = Some(error_code);
    self
  }
