...
impl InlineResponse200 {
  ...
  pub fn with_response(mut self, response: ::models::UserGeneralUser) -> InlineResponse200 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse200 {
    self.error_code = Some(error_code);
    self
  }
