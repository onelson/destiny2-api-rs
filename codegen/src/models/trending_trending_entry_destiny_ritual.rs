...
pub struct TrendingTrendingEntryDestinyRitual {
  ...
  milestone_details: Option<Object>,
...
impl TrendingTrendingEntryDestinyRitual {
  ...
  pub fn set_milestone_details(&mut self, milestone_details: Object) {
    self.milestone_details = Some(milestone_details);
  }

  pub fn with_milestone_details(mut self, milestone_details: Object) -> TrendingTrendingEntryDestinyRitual {
    self.milestone_details = Some(milestone_details);
    self
  }

  pub fn milestone_details(&self) -> Option<&Object> {
  ...
  pub fn set_event_content(&mut self, event_content: Object) {
    self.event_content = Some(event_content);
  }

  pub fn with_event_content(mut self, event_content: Object) -> TrendingTrendingEntryDestinyRitual {
    self.event_content = Some(event_content);
    self
  }

  pub fn event_content(&self) -> Option<&Object> {
