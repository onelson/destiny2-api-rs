...
impl InlineResponse2008 {
  ...
  pub fn with_response(mut self, response: Vec<::models::TagsModelsContractsTagResponse>) -> InlineResponse2008 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2008 {
    self.error_code = Some(error_code);
    self
  }
