...
impl InlineResponse2004 {
  ...
  pub fn with_response(mut self, response: ::models::UserUserMembershipData) -> InlineResponse2004 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2004 {
    self.error_code = Some(error_code);
    self
  }
