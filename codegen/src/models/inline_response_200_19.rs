...
pub struct InlineResponse20019 {
  ...
  response: Option<::models::GroupsV2GroupCreationResponse>,
...
impl InlineResponse20019 {
  ...
  pub fn set_response(&mut self, response: ::models::GroupsV2GroupCreationResponse) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: ::models::GroupsV2GroupCreationResponse) -> InlineResponse20019 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&::models::GroupsV2GroupCreationResponse> {
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20019 {
    self.error_code = Some(error_code);
    self
  }
