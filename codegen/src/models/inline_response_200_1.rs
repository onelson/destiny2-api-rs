...
pub struct InlineResponse2001 {
  ...
  response: Option<Vec<::models::UserModelsUserAlias>>,
...
impl InlineResponse2001 {
  ...
  pub fn set_response(&mut self, response: Vec<::models::UserModelsUserAlias>) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: Vec<::models::UserModelsUserAlias>) -> InlineResponse2001 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&Vec<::models::UserModelsUserAlias>> {
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse2001 {
    self.error_code = Some(error_code);
    self
  }
