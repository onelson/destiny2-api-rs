...
impl InlineResponse20054 {
  ...
  pub fn with_response(mut self, response: ::models::TrendingTrendingDetail) -> InlineResponse20054 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20054 {
    self.error_code = Some(error_code);
    self
  }
