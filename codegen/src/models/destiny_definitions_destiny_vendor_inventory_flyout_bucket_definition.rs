...
impl DestinyDefinitionsDestinyVendorInventoryFlyoutBucketDefinition {
  ...
  pub fn set_sort_items_by(&mut self, sort_items_by: Object) {
    self.sort_items_by = Some(sort_items_by);
  }

  pub fn with_sort_items_by(mut self, sort_items_by: Object) -> DestinyDefinitionsDestinyVendorInventoryFlyoutBucketDefinition {
    self.sort_items_by = Some(sort_items_by);
    self
  }

  pub fn sort_items_by(&self) -> Option<&Object> {
