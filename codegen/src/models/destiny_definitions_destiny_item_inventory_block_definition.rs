...
impl DestinyDefinitionsDestinyItemInventoryBlockDefinition {
  ...
  pub fn set_tier_type(&mut self, tier_type: Object) {
    self.tier_type = Some(tier_type);
  }

  pub fn with_tier_type(mut self, tier_type: Object) -> DestinyDefinitionsDestinyItemInventoryBlockDefinition {
    self.tier_type = Some(tier_type);
    self
  }

  pub fn tier_type(&self) -> Option<&Object> {
