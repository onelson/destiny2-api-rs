...
impl InlineResponse20049 {
  ...
  pub fn with_response(mut self, response: ::std::collections::HashMap<String, ::models::DestinyMilestonesDestinyPublicMilestone>) -> InlineResponse20049 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20049 {
    self.error_code = Some(error_code);
    self
  }
