...
impl InlineResponse20051 {
  ...
  pub fn with_response(mut self, response: ::models::CommunityCommunityLiveStatus) -> InlineResponse20051 {
    self.response = Some(response);
    self
  }
  ...
  pub fn with_error_code(mut self, error_code: ::models::ExceptionsPlatformErrorCodes) -> InlineResponse20051 {
    self.error_code = Some(error_code);
    self
  }
