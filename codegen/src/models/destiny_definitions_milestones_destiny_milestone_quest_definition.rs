...
impl DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinition {
  ...
  pub fn with_display_properties(mut self, display_properties: Object) -> DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinition {
    self.display_properties = Some(display_properties);
    self
  }
  ...
  pub fn set_quest_rewards(&mut self, quest_rewards: Object) {
    self.quest_rewards = Some(quest_rewards);
  }

  pub fn with_quest_rewards(mut self, quest_rewards: Object) -> DestinyDefinitionsMilestonesDestinyMilestoneQuestDefinition {
    self.quest_rewards = Some(quest_rewards);
    self
  }

  pub fn quest_rewards(&self) -> Option<&Object> {
